...
import 'package:week3/models/response/get_proflie.dart';
...
class _ProfilePageState extends State<ProfilePage> {
  late Future<ProfileGetResponse> loadData;
  late ProfileGetResponse profileGetResponse;
  final TextEditingController nameCtl = TextEditingController();
  final TextEditingController phoneCtl = TextEditingController();
  final TextEditingController emailCtl = TextEditingController();
  final TextEditingController imageCtl = TextEditingController();
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: FutureBuilder<ProfileGetResponse>(
        future: loadData,
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            nameCtl.text = profileGetResponse.fullname;
            phoneCtl.text = profileGetResponse.phone;
            emailCtl.text = profileGetResponse.email;
            imageCtl.text = profileGetResponse.image;
                ...
                child: Column(
                  ...
                  children: [
                    Padding(
                      ...
                      child: Image.network(
                        profileGetResponse.image,
                        width: 150,
                        errorBuilder: (context, error, stackTrace) {
                          return Icon(Icons.error,
                              size: 150); // Placeholder for image errors
                        },
                      ),
                    ),
                    Padding(
                    ...
                    Padding(
                      ...
                      child: ElevatedButton(
                        onPressed: update, // Call the update function here
                        style: ElevatedButton.styleFrom(
                          backgroundColor:
                              Color.fromARGB(255, 85, 1, 100), // Purple color
  ...
  Future<ProfileGetResponse> loadDataAsync() async {
    try {
      var config = await Configuration.getConfig();
      var url = config['apiEndpoint'];
      ...
      if (res.statusCode == 200) {
        log(res.body);
        return profileGetResponseFromJson(res.body);
      } else {
